...
**Spec:** `spec/design/step-up-tap-and-pending-approval.md` · **Version:** 1.21 · **Date:** 2026-09-23 (v1.20 · v1.19 · v1.18 · v1.17 · v1.16 · v1.15: same day · v1.14 · v1.13 · v1.12 · v1.11 · v1.10 · v1.9 · v1.8 · v1.7 · v1.6 · v1.5 · v1.4 · v1.3: 2026-09-22 · v1.2: 2026-09-21 · v1.1: 2026-09-13 · v1.0: 2026-09-11)
...
| ready | `egzos · container <name> · <host:port>` · `you · <user> · principal: interactive · present since HH:MM (UTC−07:00)` (§13 `shell.viewer`). **On the pending pages, and only there, the host's site nav renders above the viewer line** (D-T5) — in the lifeboat that is `<nav aria-label="egzos">` with *search* and *pending · N*, passed in by the shell partial `lifeboat.md` §18 describes; on `/tap/<token>` nothing is rendered in its place, not a disabled or empty slot. | ink | heading is first focus; the nav is a landmark distinct from the queue's `<nav aria-label="Pending">` | — | — |
