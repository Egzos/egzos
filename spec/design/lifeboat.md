...
**Spec:** `spec/design/lifeboat.md` · **Version:** 1.3 · **Date:** 2026-09-22 (v1.2 · v1.1: same day · v1.0: 2026-09-21)
**Owner:** A2 (Taste) · **Status:** BINDING once committed by the Chief — the commit is the approval act.
**Direction:** Docket v2 (bound 2026-09-11) · **Tokens:** `spec/design/tokens.css` v0.6 · **Principles:** `DESIGN-PRINCIPLES.md` v1.3 · **Provenance:** `DESIGN-SOURCES.md` v1.5 · **Sibling:** `step-up-tap-and-pending-approval.md` v1.8 (the pending pages and the tap page; cited here as *the tap spec*).
