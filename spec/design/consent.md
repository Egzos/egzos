...
**Spec:** `spec/design/consent.md` · **Version:** 1.4 · **Date:** 2026-09-22 (v1.3 · v1.2 · v1.1: same day · v1.0: 2026-09-21)
**Owner:** A2 (Taste) · **Status:** BINDING once committed by the Chief — the commit is the approval act.
**Direction:** Docket v2 (bound 2026-09-11) · **Tokens:** `spec/design/tokens.css` v0.6 · **Principles:** `DESIGN-PRINCIPLES.md` v1.3 · **Provenance:** `DESIGN-SOURCES.md` v1.5 · **Siblings:** `step-up-tap-and-pending-approval.md` v1.8 (*the tap spec*; the two-step act, the laws), `lifeboat.md` v1.3 (the shell patterns).
...
Not occurring on these pages: `loading`, `offline`, `unreachable`, `quota`, `quarantined`, `lapsed`, `partial`. `approved` here means *authorized* (a token minted). Colour: **red** = `error` only. **Everything else is ink** — including `denied`, `expired` and `invalid`. A refused grant is not a failure; it is a decision or a stale request.
...
| ready (many scopes) | 8 lines + `+ N more` (a link to `?full=1`) | ink | link ≥ 44 px |
