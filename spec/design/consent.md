...
**Spec:** `spec/design/consent.md` · **Version:** 1.19 · **Date:** 2026-09-24 (v1.18: 2026-09-24 · v1.17 · v1.16 · v1.15 · v1.14 · v1.13 · v1.12 · v1.11: 2026-09-23 · v1.10 · v1.9 · v1.8 · v1.7 · v1.6 · v1.5 · v1.4 · v1.3 · v1.2 · v1.1: 2026-09-22 · v1.0: 2026-09-21)
...
| stale (request re-submitted after decision: back button) | the uniform failure page — **one append, cause `replayed`** (R12 `back after decision`, §14.8 (d)) | — | — |
...
| uniform failure | *This request can't be completed.*; body empty; identical status/length/timing for all pre-trust causes | ink | `<h1>` | **[GAP→a1p]** §14.8 (d) — one append on every cause that renders this page, pre-trust and replay alike, the cause in `details`, never on the page (**D-T8**) |
