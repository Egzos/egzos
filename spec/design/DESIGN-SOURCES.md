...
| Empty (empty-state fallback, R14) | `cnippet-dev/empty`, demo **No results** · https://21st.dev/cnippet-dev/empty · **#19746** — the same component as the three rows above, a different demo | per item page | 2026-09-22 | onion-graph.md v1.0 §17 (bespoke preferred — the rings must stay drawn behind it) |
