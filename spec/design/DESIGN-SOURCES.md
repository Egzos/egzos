...
The diagram is bespoke by rule (CLAUDE.md §P: the onion *is* the product). These rows record what was
...
| Empty (empty-state fallback, R14) | https://21st.dev/cnippet-dev/empty · **#19746** | per item page | 2026-09-22 | onion-graph.md v1.0 §17 (bespoke preferred — the rings must stay drawn behind it) |
...
## Corrections log
- 2026-09-22 · `Empty · cnippet-dev` recorded as **#19745** in the 2026-09-21 research dossier; the registry item is **#19746** (verified against the 21st.dev catalogue 2026-09-22, before the id was cited in a spec). The dossier is research, not a source of record, so nothing else needed correcting — but the same class of error reached this file once before (#99 for #89) and survived three revisions, so ids are now verified at the moment of citation rather than carried forward.
